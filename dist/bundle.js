...
var renderTasks = function renderTasks() {
  ...
  tasks.forEach(function (task) {
    ...
    li.innerHTML = "\n              ".concat(task.text, "\n              <button class=\"delete\"> Eliminar </button>\n              <button class=").concat(task.completed === false ? "toggle" : "undo", "> ").concat(task.completed === false ? "Completar" : "Deshacer", " </button>\n              ");
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  document.getElementById("task-list").addEventListener("click", function (e) {
    ...
    if (e.target.classList.contains("undo")) {
      var _taskId2 = e.target.parentElement.getAttribute("data-id");
      (0,_task__WEBPACK_IMPORTED_MODULE_1__.updateTask)(_taskId2);
      (0,_ui__WEBPACK_IMPORTED_MODULE_0__.renderTasks)();
    }
  });
});
